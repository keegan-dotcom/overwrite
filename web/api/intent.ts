...
- strategyId: the single best fit. Earning yield/income on a held asset → income. Getting paid while waiting to buy lower → wheel. Protection with upside kept → shield. Protection paid for by a cap / "costs nothing" → collar. Betting on a fall with capped risk → bear.
